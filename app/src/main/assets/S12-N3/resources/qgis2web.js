...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-15.824558, -2.335406, 24.243845, 16.103840], maxZoom: 24, minZoom: 21, projection: 'EPSG:3786'
    })
});
map.getView().fit([-15.824558, -2.335406, 24.243845, 16.103840], map.getSize());
